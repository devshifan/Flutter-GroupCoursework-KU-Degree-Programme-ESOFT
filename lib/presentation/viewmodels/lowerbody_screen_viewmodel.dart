...
class LowerbodyScreenViewModel extends ChangeNotifier {
  ...
  Future<List<WorkoutModel>> loadWorkouts() async {
    try {
      ...
      if (activeUser != null) {
        ...
        _upperBodyWorkouts = await fetchLowerbodyWorkouts(bmiCategory, gender);
  ...
  Future<List<WorkoutModel>> fetchLowerbodyWorkouts(
